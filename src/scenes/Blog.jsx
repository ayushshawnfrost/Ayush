    ...
    <section id="blog" className="pt-32 pb-16">
      ...
      >
        ...
        <p className="mt-10 text-xl font-playfair">
          I'm thrilled to share my journey and expertise in Softwarer
          Engineering through my Medium blog. My articles have <br />
          <span className="text-yellow">500+ </span>monthly readers.
        </p>
      </motion.div>
      {/* TESTIMONIALS */}
      <div className="md:flex md:justify-between gap-8">
        <motion.div
          className="mx-auto relative bg-blue max-w-[400px] h-[350px] flex flex-col justify-top p-10 mt-48
        ...
        >
          ...
          <a
            ...
            href="https://medium.com/@ayushjudesharp/building-fan-out-serverless-architectures-using-sns-sqs-and-lambda-event-driven-architecture-911a7b4eadfb"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <p className="text-center text-xl">
            Building Fan-Out Serverless Architectures Using SNS, SQS and Lambda
        ...
        >
          ...
          <p className="font-playfair text-6xl">“</p>
          <p className="text-center text-xl">
            Building a Serverless REST API with AWS Lambda(Node.js) and
            DynamoDB.
          </p>
        </motion.div>
